...
import numpy as np
import pandas as pd
from generate_adj_mx import generate_adj_tfa
...
if __name__ == "__main__":
    ...
    DATA_FILE_PATH = "datasets/raw_data/{0}/{0}_vol.csv".format(DATASET_NAME)
