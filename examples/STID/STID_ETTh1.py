...
CFG.GPU_NUM = 1
CFG.RESCALE = False
CFG.METRICS = {"MAE": masked_mae, "MSE": masked_mse}    # Because rescale is False, then the metrics are computed on the normalized data, which maskes metrics like MAPE and WAPE meaningless.
